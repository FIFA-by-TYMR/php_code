...
if ($validate->validateNumberMinus($arr_score[0], $arr_score[1]) == true){
    if ($validate->validateNumberIsNumber($arr_score[0], $arr_score[1]) == true)
    {
        ...
        $_SESSION['success'] = "Scores zijn aangepast voor volgende match: ".$match['team_a']. " VS " . $match['team_b']. "!";
    }
    else{
        $_SESSION['error'] = "Het ingevulde score moet een nummer zijn!";
    }
}
else
{
    $_SESSION['error'] = "Je hebt geen geldige score ingevoerd. Score mag geen - bevatten!";
}
