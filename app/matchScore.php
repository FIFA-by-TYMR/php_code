...
foreach ($_SESSION['matchSelect'] as $match){
    echo "
    <form action='../../app/addresult.php' method='post' class='form-horizontal form-inline col-md-8 col-md-offset-2'>
        <div class='form-group addresult col-md-6'>
            <label for='TeamA' class='control-label'>Score ".$match['team_a']."</label>
            <input type='number' id='TeamA' placeholder='0' min='0' class='' name='TeamAScore' required>
        </div>
        <div class='form-group addresult col-md-6 pull-right'>
            ...
            <input type='number' id='TeamB' placeholder='0' min='0' class='control-label' name='TeamBScore' required>
        </div>
