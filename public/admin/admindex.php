    ...
    <div class="main-content">
        <div class="container wrapper">
            ...
            <div class="col-md-3">
                ...
                <form action="../../app/timeSetUp.php" method="post" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <input type="number" id="first" name="first" placeholder="30" min="0" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label for="pause" class="control-label">Pauze duurt:</label>
                        <input type="number" id="pause" name="pause" placeholder="15" min="0" class="form-control"  required>
                    </div>
                    <div class="form-group">
                        <label for="second" class="control-label">Twede helft duurt:</label>
                        <input type="number" id="second" name="second" placeholder="30" min="0" class="form-control"  required>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-md-4 col-md-push-1">
                ...
                <h2 class="text-center">Team Terugzetten</h2>
                <form action="../../app/revertTeam.php" method="post">
                    <div class="form-group">
                        <select name="select_catalog" class="form-control">
                            <?php
                            require "../../app/revertTeamSelect.php";
                            ?>
                        </select>
                    </div>
                    <div class="form-group">
