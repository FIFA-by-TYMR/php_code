    ...
    <div class="container">
        <form action="../app/login.php" method="post" class="form-horizontal col-md-6 col-md-offset-3">
            <div class="form-group">
                ...
                <input type="email" id="Email" name="email" placeholder="vorbeeld@hotmail.nl" class="form-control">
            </div>
            <div class="form-group">
                <label for="Pass">Wachtwoord</label>
                <input type="password" id="Pass" name="pass" placeholder="vorbeeld@hotmail.nl" class="form-control">
            </div>
            <div class="form-group">
